    ...
    <div class="hvr-glow" id="contenido">
        <div class="central">
        	<form id="formulario_contacto" action="#" method="post" name="formulario_contacto" >
                ...
                <label class="caja_input_area"><textarea  rows="11" cols="35" name="mensaje" id="mensaje" class="input_text_area" onKeyPress="return tecla_direccion(event)" onBlur="limpiaDireccion('mensaje',2,1)"  ></textarea></label>
