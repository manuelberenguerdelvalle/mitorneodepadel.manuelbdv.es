...
?>
    ...
    <div class="caja1">
        <div class="columna1">
            ...
            <div class="cuadroTexto" onMouseOver="showdiv(event,'Puntos por victoria en partido de torneo.');" onMouseOut="hiddenDiv()" style='display:table;'>Victoria en partido torneo:</div>
            <div class="cuadroTexto" onMouseOver="showdiv(event,'Puntos por pasar a dieciseisavos en el torneo.');" onMouseOut="hiddenDiv()" style='display:table;'>Clasificarse a dieciseisavos:</div>
            <div class="cuadroTexto" onMouseOver="showdiv(event,'Puntos por clasificarse para octavos en el torneo.');" onMouseOut="hiddenDiv()" style='display:table;'>Clasificarse a octavos:</div>
            <div class="cuadroTexto" onMouseOver="showdiv(event,'Puntos por clasificarse para cuartos en el torneo.');" onMouseOut="hiddenDiv()" style='display:table;'>Clasificarse a cuartos:</div>
            <div class="cuadroTexto" onMouseOver="showdiv(event,'Puntos por clasificarse para la semifinal en el torneo.');" onMouseOut="hiddenDiv()" style='display:table;'>Clasificarse para la semifinal:</div>
            <div class="cuadroTexto" onMouseOver="showdiv(event,'Puntos por clasificarse para la final en el torneo.');" onMouseOut="hiddenDiv()" style='display:table;'>Clasificarse para la final:</div>
            <div class="cuadroTexto" onMouseOver="showdiv(event,'Puntos por ser subcampe&oacute;n del torneo.');" onMouseOut="hiddenDiv()" style='display:table;'>Subcampe&oacute;n torneo:</div>
            <div class="cuadroTexto" onMouseOver="showdiv(event,'Puntos por ser campe&oacute;n el torneo.');" onMouseOut="hiddenDiv()" style='display:table;'>Campe&oacute;n torneo:</div>
        </div>
        <div id="flotante"></div>
        <div class="columna2">
        ...
        <div class="columna3">
            ...
            <div class="cuadroComentario"><span id="dieciseisavosCom">* Introduzca un n&uacute;mero.</span></div>
            <div class="cuadroComentario"><span id="octavosCom">* Introduzca un n&uacute;mero.</span></div>
            <div class="cuadroComentario"><span id="cuartosCom">* Introduzca un n&uacute;mero.</span></div>
            <div class="cuadroComentario"><span id="semifynalCom">* Introduzca un n&uacute;mero.</span></div>
            <div class="cuadroComentario"><span id="fynalCom">* Introduzca un n&uacute;mero.</span></div>
