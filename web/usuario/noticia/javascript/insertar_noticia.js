...
function enviar(){
		...
		$("#respuesta").html('<div style="margin-left:31%; margin-top:0.5%;"><img src="../../../images/28.gif" width="50"></div><div style="margin-left:15%;">Por favor espere, este proceso puede tardar entre 30 segundos y varios minutos, <br>dependiendo de la calidad de la imagen y la conexión a internet, gracias.</div>');
		$("#btn_enviar").hide();
