...
if($consulta->num_rows > 0){
	...
	<div class="caja"> 
        ...
        <div class="datos3">
        	<?php //muestra_formulario($descrip_pago,$resultados2['id_pago_web'].rand(),$resultados2['precio'],'http://www.mitorneodepadel.es/web/usuario/pago/gestion_pago.php','http://www.mitorneodepadel.es/web/recibir_pagos/pago_web.php','manu_oamuf-facilitator@hotmail.com');
			//muestra_formulario($descrip_pago,$resultados2['id_pago_web'],$resultados2['precio'],'http://www.mitorneodepadel.es/web/usuario/pago/gestion_pago.php','http://www.mitorneodepadel.es/web/recibir_pagos/pago_web.php','manu_oamuf-facilitator@hotmail.com'); 
			muestra_formulario($descrip_pago,$resultados2['id_pago_web'],$resultados2['precio'],'http://www.mitorneodepadel.es/web/usuario/pago/gestion_pago.php','http://www.mitorneodepadel.es/web/recibir_pagos/pago_web.php',cuenta_admin()); 
			?>
        </div>  
	</div>
<?php
...
if($consulta->num_rows > 0){
	while($resultados = $consulta->fetch_array(MYSQLI_ASSOC)){
		$db2 = new MySQL('unicas');//torneo PADEL
