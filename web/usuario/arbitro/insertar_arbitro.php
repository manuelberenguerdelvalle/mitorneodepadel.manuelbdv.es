...
<div class="columna1">
    ...
    <div class="cuadroTexto" onMouseOver="showdiv(event,'Opcional: Introduce el telefono.');" onMouseOut="hiddenDiv()" style="display:table;">Telfono:</div>
    ...
    <div class="cuadroTexto" onMouseOver="showdiv(event,'Opcional: Introduce el cdigo postal.');" onMouseOut="hiddenDiv()" style="display:table;">Cdigo postal:</div>
...
<div class="columna3">
    ...
    <div class="cuadroComentario"><span id="apellidosCom">Introduzca datos correctos o d&eacute;jelo vac&iacute;o.</span></div>
    <div class="cuadroComentario"><span id="dniCom">Introduzca datos correctos o d&eacute;jelo vac&iacute;o.</span></div>
    <div class="cuadroComentario"><span id="telefonoCom">Introduzca datos correctos o d&eacute;jelo vac&iacute;o.</span></div>
    <div class="cuadroComentario"><span id="direccionCom">Introduzca datos correctos o d&eacute;jelo vac&iacute;o.</span></div>
    <div class="cuadroComentario"><span id="cpCom">Introduzca datos correctos o d&eacute;jelo vac&iacute;o.</span></div>
