...
if ( isset($_POST['email']) ){//SI EXISTE POST
	...
	if($consulta->num_rows == 0){//SI NO EXISTE EL USUARIO LO REGISTRO
		...
		//$link = 'http://www.mitorneodepadel.es/web/usuario/gestion_datos.php?id=MTIzNDU2Nzg5MA==';
		//$link = 'http://www.mitorneodepadel.es/web/v/v/valida_registro.php?id=MTIzNDU2Nzg5MA==';
		//CAMBIAR A DINAMICO
		...
		$link = 'http://www.mitorneodepadel.es/web/v/v/valida_registro.php?id='.$id;
