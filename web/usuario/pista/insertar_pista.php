...
<div class="columna1">
    ...
    <div class="cuadroTexto" onMouseOver="showdiv(event,'Opcional: Introduce la direccin.');" onMouseOut="hiddenDiv()" style='display:table;'>Direcci&oacute;n:</div>
    <div class="cuadroTexto" onMouseOver="showdiv(event,'Opcional: Introduce el cdigo postal.');" onMouseOut="hiddenDiv()" style='display:table;'>C&oacute;digo postal:</div>
</div>
<div id="flotante"></div>
<div class="columna2">
