...
<div class="columna1">
    ...
    <div class="cuadroTexto" onMouseOver="showdiv(event,'Torneo Premium: Se utilizar&aacute; para el acceso a tu torneo si la visibilidad es privada y para insertar resultados de partidos.');" onMouseOut="hiddenDiv()" style='display:table;'>Contrase&ntilde;a:</div>
    ...
    <div class="cuadroTexto" onMouseOver="showdiv(event,'Torneo Premium: Introduce el n&uacute;mero de ascensos y descensos.');" onMouseOut="hiddenDiv()" style='display:table;'>Ascensos/Descensos:</div>
