...
else if($tipo_pago == 2){$max_movimientos = 4;}
else if($tipo_pago == 3){$max_movimientos = 8;}
else{}
...
<script>
<?php
//DATOS JAVASCRIPT:Entra aqui si es nueva torneo o modifica por primera vez
...
<div class="caja1">
    <div class="columna1">
        ...
        <div class="cuadroTexto" onMouseOver="showdiv(event,'La contrase&ntilde;a se utilizar&aacute; para que los jugadores puedan inscribirse primero y despu&eacute;s para acceder a tu torneo si la visibilidad es privada.');" onMouseOut="hiddenDiv()" style='display:table;'>Contrase&ntilde;a:</div>
        ...
        <div class="cuadroTexto" onMouseOver="showdiv(event,'Torneo Premium: Esta opci&oacute;n permite seleccionar si desea tambien grupos.');" onMouseOut="hiddenDiv()" style="display:table;">Modalidad:</div>
    ...
    if($tipo_pago == 0 || $num_comienzos > 0){//para que puedan modificar antes de crear el calendario
