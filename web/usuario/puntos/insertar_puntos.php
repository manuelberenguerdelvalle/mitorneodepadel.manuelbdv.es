...
?>
	<br>
	<div class="horizontal"><div class="titulo"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Insertar Puntos Manualmente</b></div></div>
    <div class="caja1">
<?php
...
?>	
		 <div class="columna1">
            <div class="cuadroTexto"><?php echo $jugador1->getValor('nombre').' '.$jugador1->getValor('apellidos').' (<b>'.$sumPuntos.' ptos</b>)';?>&nbsp;&nbsp;</div>
        </div>
        <div id="flotante"></div>
        <div class="columna2">
        ...
        <div class="columna3">
            <div class="cuadroComentario"><input type="button" value="+" class="boton" onClick="enviar(<?php echo $id_jugador1;?>,'sumar')" /><input type="button" value="-" class="boton" onClick="enviar(<?php echo $id_jugador1;?>,'restar')" /></div>
        </div>
...
?>	
		 <div class="columna1">
            <div class="cuadroTexto"><?php echo $jugador2->getValor('nombre').' '.$jugador2->getValor('apellidos').' (<b>'.$sumPuntos.' ptos</b>)';?>&nbsp;&nbsp;</div>
        </div>
        <div id="flotante"></div>
        <div class="columna2">
        ...
        <div class="columna3">
            <div class="cuadroComentario"><input type="button" value="+" class="boton" onClick="enviar(<?php echo $id_jugador2;?>,'sumar')" /><input type="button" value="-" class="boton" onClick="enviar(<?php echo $id_jugador2;?>,'restar')" /></div>
        </div>
<?php	
		}//fin if jugador2
	}//fin while
