...
*/
	//if($crear_calendario == 'S'){//crear calendario
...
<div id="flotante"></div>
<?php if($tipo_pago > 0){
		echo '<div class="horizontal"><div><input type="radio" name="calendario" value="personalizado" onClick="comprueba(this)"><b>Personalizado</b> (Podr&aacute;s configurar los grupos y horarios para generar el calendario)</div></div>';
}	?>
<div class="general">
    <div class="columna1">
        ...
        <div class="cuadroTexto" onMouseOver="showdiv(event,'Indica la duracin mxima o estimada por partido para el clculo del horario.');" onMouseOut="hiddenDiv()" style='display:table;'>Duraci&oacute;n por partido aprox:</div>
        ...
        <div class="cuadroTexto" onMouseOver="showdiv(event,'Personaliza el horario para tu liga, si no deseas insertar horas djalas en blanco.');" onMouseOut="hiddenDiv()" style='display:table;'>Horario:</div>
	<?php if($idayvuelta == 'S'){ ?>
        <div class="cuadroTexto" style='display:table;'>&nbsp;</div><div class="cuadroTexto" style='display:table;'>&nbsp;</div><div class="cuadroTexto" style='display:table;'>&nbsp;</div>
        <div class="cuadroTexto" style='display:table;'>&nbsp;</div><div class="cuadroTexto" style='display:table;'>&nbsp;</div><div class="cuadroTexto" style='display:table;'>&nbsp;</div>
        <div class="cuadroTexto" onMouseOver="showdiv(event,'Haz click para configurar los grupos manualmente.');" onMouseOut="hiddenDiv()" style='display:table;'>Crear grupos manual:</div>
	<?php } ?>
    </div>
    <div class="columna2">
        ...
        <span class="cuadroInputs"><?php duracion_partido('').sets('');?></span>
        ...
        <span class="cuadroInputs"><input type="checkbox" name="domingo" id="domingo" value="domingo" onClick="comprueba_linea(this)">Domingo</span>
    <?php
    if($idayvuelta == 'S'){
        echo '<span class="cuadroInputs"><input type="checkbox" name="grupos" id="grupos" value="grupos" onClick="comprueba_linea3(this)"></span>';
    }
    ?>
        </form>
    </div>
    ...
    <div class="columna9">
		...
		while($resultados = $consulta->fetch_array(MYSQLI_ASSOC)){
			...
			echo '<div class="numEquipo">'.($cont+1).'</div><div class="equipo1">'.substr($resultados['nombre1'].' '.$resultados['apellidos1'],0,35).'</div><div class="pelota"><img src="../../../images/pelota.png" width="50%"></div><div class="equipo2">'.substr($resultados['nombre2'].' '.$resultados['apellidos2'],0,35).'</div>';
    ...
    <div class="columna10">
    	...
    	<?php
			for($i=0; $i<$cont; $i++){
				...
				echo '<div class="grupos"><select name="cont_grupo'.$i.'" id="cont_grupo'.$i.'" class="input_select_liga">';
