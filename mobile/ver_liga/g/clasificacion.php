...
.linea_elim_gana_int_horizontal{
	width:100% !important;
	height:50% !important;
	text-align:center;
	color:#003;
...
.linea_elim_gana_int_horizontal2{
	width:100% !important;
	height:50% !important;
	text-align:center;
	color:#003;
...
<?php } ?>
        ...
        <div class="contenido">
			...
			?>
				<div class="caja2">
				<?php	
					if($resultados['local'] == $resultados['ganador'] && $eliminatoria == 1){echo '<div class="cuadro_elim_ganador">';}
             ...
             <?php
			 if($eliminatoria != 1){//si no es la final
				if($resultados['local'] == $resultados['ganador']){
					echo '<div class="linea_elim"><div class="linea_elim_gana_int_vacio">&nbsp;</div><div class="linea_elim_gana_int_horizontal">&nbsp;</div><div class="linea_elim_gana_int_vertical">&nbsp;</div><div class="linea_elim_gana_int_vertical">&nbsp;</div></div>
					<div class="linea_elim"><div class="linea_elim_gana_int_vacio">&nbsp;</div><div class="linea_elim_gana_int_vacio">&nbsp;</div><div class="linea_elim_gana_int_vacio">&nbsp;</div><div class="linea_elim_gana_int_horizontal">&nbsp;</div></div>';
				}
				else{
					echo '<div class="linea_elim"><div class="linea_elim_gana_int_vacio">&nbsp;</div><div class="linea_elim_int_horizontal">&nbsp;</div><div class="linea_elim_int_vertical">&nbsp;</div><div class="linea_elim_int_vertical">&nbsp;</div></div>
					<div class="linea_elim"><div class="linea_elim_gana_int_vacio">&nbsp;</div><div class="linea_elim_gana_int_vacio">&nbsp;</div><div class="linea_elim_gana_int_vacio">&nbsp;</div>';
					if($resultados['ganador'] != 0){echo '<div class="linea_elim_gana_int_vacio">&nbsp;</div>';}
					else{echo '<div class="linea_elim_int_horizontal">&nbsp;</div>';}
					echo '</div>';
				}
			 }//fin si no final
				//cuadro siguiente pareja
				if($resultados['visitante'] == $resultados['ganador'] && $eliminatoria == 1){echo '<div class="cuadro_elim_ganador">';}
			 ...
			 ?>
					 ...
					 <?php
					 	if($eliminatoria != 1){//si no es la final
							if($resultados['visitante'] == $resultados['ganador']){
								echo '<div class="linea_elim"><div class="linea_elim_gana_int_vertical">&nbsp;</div><div class="linea_elim_gana_int_vertical">&nbsp;</div><div class="linea_elim_gana_int_horizontal2">&nbsp;</div><div class="linea_elim_gana_int_vacio">&nbsp;</div></div>
					<div class="linea_elim"><div class="linea_elim_gana_int_horizontal2">&nbsp;</div><div class="linea_elim_gana_int_vacio">&nbsp;</div><div class="linea_elim_gana_int_vacio">&nbsp;</div><div class="linea_elim_gana_int_vacio">&nbsp;</div></div>';
							}
							else{
								echo '<div class="linea_elim"><div class="linea_elim_int_vertical">&nbsp;</div><div class="linea_elim_int_vertical">&nbsp;</div><div class="linea_elim_int_horizontal2">&nbsp;</div><div class="linea_elim_gana_int_vacio">&nbsp;</div></div>
					<div class="linea_elim"><div class="linea_elim_gana_int_vacio">&nbsp;</div><div class="linea_elim_gana_int_vacio">&nbsp;</div><div class="linea_elim_gana_int_vacio">&nbsp;</div><div class="linea_elim_gana_int_vacio">&nbsp;</div></div>';
							}
						}//fin si no es final
					?>
				</div><!-- fin caja -->
