...
<div class="principal"> 
    <div class="cabecera">
        <div class="logo">
            ...
            <div class="comentarioLogo">Administraci&oacute;n de Torneos de Padel para Particulares y Clubs Profesionales</div>
        </div>
        <div class="opciones">
            ...
            <div class="acceso2">
                ...
                <div><a class="link" href="usuario/registro/elegir_plan.php"><b>NUEVO<br />TORNEO</b></a></div>
    ...
    <div class="central_grande">
        ...
        <div id="reproductor" class="reproductor">
            ...
            <ul>
                ...
                <li class='num0 img slide'>  <a href="http://www.mitorneodepadel.es/mobile/usuario/registro/elegir_plan.php" target="_blank"><img src='../cssslider_files/csss_images1/fotolia_58638107_s.jpg' alt='CLONPADEL TORNEO' title='CLONPADEL TORNEO' /> </a> </li>
                <li class='num1 img slide'>  <a href="http://www.mitorneodepadel.es/mobile/usuario/registro/elegir_plan.php" target="_blank"><img src='../cssslider_files/csss_images1/fotolia_94925196_s.jpg' alt='TORNEOS PREMIUM' title='TORNEOS PREMIUM' /> </a> </li>
                <li class='num2 img slide'>  <a href="http://www.mitorneodepadel.es/mobile/usuario/registro/elegir_plan.php" target="_blank"><img src='../cssslider_files/csss_images1/fotolia_70678968_s.jpg' alt='TORNEOS GRATIS' title='TORNEOS GRATIS' /> </a> </li>
                <li class='num3 img slide'>  <a href="http://www.mitorneodepadel.es/mobile/usuario/registro/elegir_plan.php" target="_blank"><img src='../cssslider_files/csss_images1/fotolia_72495241_s.jpg' alt='mitorneodepadel.es' title='mitorneodepadel.es' /> </a> </li>
        ...
        <div class="videotutoriales">
            ...
            <div id="canales" class="v_contenido">
            	<div class="canal"><a class="link_canal" href="https://youtu.be/xrQKauYoUOE" target="_blank">-Ver Canal Torneos Premium</a></div>
				<div class="canal"><a class="link_canal" href="https://youtu.be/xrQKauYoUOE" target="_blank">-Ver Canal Torneos Gratis</a></div>
            </div>
