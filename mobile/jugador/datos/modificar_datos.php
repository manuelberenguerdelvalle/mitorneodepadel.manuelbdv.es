...
<div class="columna1">
    ...
    <div class="cuadroTexto" onMouseOver="showdiv(event,'Si desea cambiar su contrase&ntilde;a, Introduce la contrase&ntilde;a actual.');" onMouseOut="hiddenDiv()" style="display:table;">Pass Actual:</div>
    <div class="cuadroTexto" onMouseOver="showdiv(event,'Si desea cambiar su contrase&ntilde;a, Introduce la nueva contrase&ntilde;a');" onMouseOut="hiddenDiv()" style="display:table;">Pass Nueva:</div>
    <div class="cuadroTexto" onMouseOver="showdiv(event,'Si desea cambiar su contrase&ntilde;a, Repite la nueva contrase&ntilde;a');" onMouseOut="hiddenDiv()" style="display:table;">Repetir:</div>
...
<div class="columna4">
	<div class="aviso">Si no ve correctamente alguna imagen, es porque se est&aacute; efectuando la validaci&oacute;n en el servidor, actualice la p&aacute;gina en unos minutos.</div>
