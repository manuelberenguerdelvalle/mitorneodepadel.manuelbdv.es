		...
		<div class="caja"> 
			...
			<div class="datos3">
				...
				if($resultados['modo_pago'] == 'P'){//si el modo de pago es online
					...
					//muestra_formulario($descrip_pago,$resultados['id_pago_admin'],0.5,'http://www.mitorneodepadel.es/mobile/jugador/pago/gestion_pago.php','http://www.mitorneodepadel.es/mobile/ep/pa.php',$resultados['receptor']);
					muestra_formulario(utf8_encode($descrip_pago),$resultados['id_pago_admin'],$resultados['precio'],'http://www.mitorneodepadel.es/mobile/jugador/pago/gestion_pago.php','http://www.mitorneodepadel.es/mobile/ep/pa.php',$resultados['receptor']);
					//muestra_formulario($descrip_pago,$resultados['id_pago_admin'],$resultados['precio'],'http://www.mitorneodepadel.es/mobile/jugador/pago/gestion_pago.php','http://www.mitorneodepadel.es/mobile/ep/pa.php','manu_oamuf-facilitator@hotmail.com');
				}//fin pago online
				else{
			...
			<div class="datos3">
				...
				<!--<label class="datos_linea_boton">
				<form name="<?php //echo $resultados['id_pago_admin'];?>" action="justificante.php" method="post" target="_parent">
