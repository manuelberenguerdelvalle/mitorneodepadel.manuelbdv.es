...
if($consulta->num_rows > 0){
	...
	<div class="caja"> 
		...
		?>
        <div class="datos4">
        	<?php muestra_formulario(utf8_encode($descrip_pago),$resultados['id_pago_web'],$resultados['precio'],'http://www.mitorneodepadel.es/mobile/usuario_publi/pago/gestion_pago.php','http://www.mitorneodepadel.es/mobile/ep/pw.php',cuenta_admin()); 		
			?>
        </div>
        <?php
		}
