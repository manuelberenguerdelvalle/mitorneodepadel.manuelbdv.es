...
var genero_liga='<?php echo $genero_liga; ?>';
</script><!-- para saber la combinación de generos-->
<script src="javascript/insertar_inscripcion.js" type="text/javascript"></script>
</head>
<body>
<div class="caja_jugador">
    <div class="horizontal">&nbsp;</div>
    <div class="horizontal">JUGADOR 1 <?php if($genero_liga == 'A'){echo '(Masculino)';} ?></div>
    <div class="horizontal">
        <div class="opcion"><input type="radio" name="jugador1" id="jugador1" value="buscar1" checked onClick="comprueba(this)"><b>Buscar</b></div>
        <div class="opcion"><input type="radio" name="jugador1" id="jugador1" value="insertar1" onClick="comprueba(this)"><b>Insertar</b></div>
    </div>
    <div id="jug1_col1" class="columna1">
        <div class="cuadroTexto" onMouseOver="showdiv(event,'Obligatorio: Nombre.');" onMouseOut="hiddenDiv()" style="display:table;">Nombre:</div>
        <div class="cuadroTexto" onMouseOver="showdiv(event,'Obligatorio: Apellidos.');" onMouseOut="hiddenDiv()" style="display:table;">Apellidos:</div>
        <!-- AQUI VA LA CONTRASE`A PERO INSERCI"N MANUAL NO TIENE -->
        <div class="cuadroTexto" onMouseOver="showdiv(event,'Opcional: Dirección.');" onMouseOut="hiddenDiv()" style="display:table;">Direcci&oacute;n:</div>
        <div class="cuadroTexto" onMouseOver="showdiv(event,'Obligatorio: Fecha de Nacimiento.');" onMouseOut="hiddenDiv()" style="display:table;">Fecha nacimiento:</div><!-- Si no es de pago se bloquea-->
        <div class="cuadroTexto" onMouseOver="showdiv(event,'Obligatorio: País.');" onMouseOut="hiddenDiv()" style="display:table;">Pa&iacute;s:</div>
        <div class="cuadroTexto" onMouseOver="showdiv(event,'Obligatorio: Provincia.');" onMouseOut="hiddenDiv()" style="display:table;">Provincia:</div>
        <div class="cuadroTexto" onMouseOver="showdiv(event,'Obligatorio: Ciudad.');" onMouseOut="hiddenDiv()" style="display:table;">Ciudad:</div>
        <div class="cuadroTexto" onMouseOver="showdiv(event,'Opcional: Teléfono, recomendable para introducir resultados y acceso a tu perfil.');" onMouseOut="hiddenDiv()" style="display:table;">Tel&eacute;fono:</div>
        <div class="cuadroTexto" onMouseOver="showdiv(event,'Obligatorio: Email, se utilizará para introducir resultados y acceso a tu perfil.');" onMouseOut="hiddenDiv()" style="display:table;">E-mail:</div>
        <div class="cuadroTexto" onMouseOver="showdiv(event,'Obligatorio: Contraseña, se utilizará para introducir resultados y acceso a tu perfil.');" onMouseOut="hiddenDiv()" style="display:table;">Contraseña:</div>
        <div class="cuadroTexto" onMouseOver="showdiv(event,'Opcional: Nif.');" onMouseOut="hiddenDiv()" style="display:table;">Nif:</div>
         ...
         if($genero_liga == 'A'){//si es liga mixta
            echo '<div class="cuadroTexto">Género:</div>';
         }
         ?>
    </div>
    <div id="flotante"></div>
    <div id="jug1_col2" class="columna2">
        ...
        <span class="cuadroInputs"><input type="text" name="direccion1" id="direccion1" class="input_text_liga"  onkeypress="return tecla_direccion(event)" onBlur="limpiaDireccion('direccion1',2,<?php echo $tipo_pago ?>)" ></span>
    ...
    <div id="div_bus1" class="cuadroBusqueda"><input type="text" id="busqueda" class="inputBusqueda" /></div>
    <div id="resultado" class="cuadroResultado"></div>
    <div id="seleccionado" class="horizontal"></div>
</div><!-- FIN DIV JUGADOR 1 -->
<div class="caja_jugador">
	<div class="horizontal">&nbsp;</div>
    <div class="horizontal">JUGADOR 2 <?php if($genero_liga == 'A'){echo '(Femenino)';} ?></div>
    <div class="horizontal">
        <div class="opcion"><input type="radio" name="jugador2" value="buscar2" checked onClick="comprueba(this)"><b>Buscar</b></div>
        <div class="opcion"><input type="radio" name="jugador2" value="insertar2" onClick="comprueba(this)"><b>Insertar</b></div>
    </div>
    ...
    <div id="div_bus2" class="cuadroBusqueda"><input type="text" id="busqueda2" class="inputBusqueda" /></div>
    <div id="resultado2" class="cuadroResultado"></div>
    <div id="seleccionado2" class="horizontal"></div>
</div><!-- FIN DIV JUGADOR 2 -->
<div class="horizontal"><input type="button" id="btn_enviar" value="Inscribir" style="border-radius:5px;" /></form></div>
