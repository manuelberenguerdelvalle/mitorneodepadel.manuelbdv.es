// JavaScript Document
function finalizar(liga){
	if(liga > 0){
		var url = "finalizar.php"; // El script a dónde se realizará la petición.
		...
		$("#respuesta2").html('Finalizando, por favor espere...'); // Mostrar la respuestas del script PHP
		$("#btn_enviar").hide();
		$.ajax({
				   type: "POST",
				   url: url,
