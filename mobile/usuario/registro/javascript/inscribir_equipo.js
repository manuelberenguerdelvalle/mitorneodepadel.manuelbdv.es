							...
							//alert(tipo_pago);
							 if(tipo_pago != 0 && precio > 0){
					   		...
					   		if(data == '-11'){//-1 jugador 1
						   		$("#actualizacionTexto").html('Error, el jugador 1 ya esta inscrito en este torneo.'); // Mostrar la respuestas del script PHP.
					   		}
							else if(data == '-12'){//-1 jugador 2
						   		$("#actualizacionTexto").html('Error, el jugador 2 ya esta inscrito en este torneo.'); // Mostrar la respuestas del script PHP.
					   		}
							else if(data == '-13'){//-1 jugador 1 y 2
						   		$("#actualizacionTexto").html('Error, los jugadores ya estan inscritos en este torneo.'); // Mostrar la respuestas del script PHP.
					   		}
