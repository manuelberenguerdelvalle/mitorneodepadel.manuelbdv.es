...
<?php if($_SESSION['tipo_pago'] != 0){ ?>
      		<div class="label"><div class="alinearD" onMouseOver="showdiv(event,'Es muy importante introducir tu Nif correctamente para poder recibir pagos online con total confianza.');" onMouseOut="hiddenDiv()" style="display:table;">Nif:</div></div>
