...
<div class="horizontal">&nbsp;</div>
<div class="columna1">
    <div class="cuadroTexto" onMouseOver="showdiv(event,'Este es el precio que cada jugador deber abonar para participar en esta divisi&oacute;n/torneo.');" onMouseOut="hiddenDiv()" style="display:table;">Inscripcion(&euro;):</div>
    <!--<div class="cuadroTexto" onMouseOver="showdiv(event,'Esta fecha es la que indica el comienzo de las inscripciones de los jugadores para esta divisin/torneo. Si no quieres activarla ahora djala en blanco.');" onMouseOut="hiddenDiv()" style='display:table;'>Fecha fin:</div>-->
